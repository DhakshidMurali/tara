...
func (v EmployeeCollaboratedWithEmployee) MakeQuery() string {
...
func (v EmployeeCollaboratedWithEmployee) MakeParams() map[string]any {
...
func (v EmployeeWorksInTools) MakeQuery() string {
	query := constant.CREATE_NODE_TO_NODE_RELATION
	mapData := map[string]string{
		"%n1": constant.EmployeeN1,
		"%r":  constant.WorksIn,
...
func (v EmployeeWorksInTools) MakeParams() map[string]any {
	return map[string]any{
...
func (v EmployeeSkilledInSkills) MakeQuery() string {
	query := constant.CREATE_NODE_TO_NODE_RELATION
	mapData := map[string]string{
		"%n1": constant.EmployeeN1,
...
func (v EmployeeSkilledInSkills) MakeParams() map[string]any {
	return map[string]any{
		"EmployeeName":         v.Employee.Name,
		"EmployeeMailAddress":  v.Employee.MailAddress,
		"EmployeeDomain":       v.Employee.Domain,
...
func (v EmployeeReportToEmployee) MakeQuery() string {
	query := constant.CREATE_NODE_TO_NODE_RELATION
	mapData := map[string]string{
		"%n1": constant.EmployeeN1,
		"%r":  constant.ReportTo,
...
func (v EmployeeReportToEmployee) MakeParams() map[string]any {
	return map[string]any{
		"EmployeeName":           v.Employee.Name,
		"EmployeeMailAddress":    v.Employee.MailAddress,
		"EmployeeDomain":         v.Employee.Domain,
